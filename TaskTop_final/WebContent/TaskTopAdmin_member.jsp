            ...
            <table>
            	<tr>
            		<td colspan = 3 align = "center">
            			<img src="./img/profile/sejin.png" alt="user" width = "250px" height = "250px" style = "padd
: 20px; width:300px; height: 300px; border-radius: 50%; background: #2dca98">
...
function content2(){
	location.href ="/TaskTop_final/content2.do";

}
function content3(){
	location.href = "/TaskTop_final/content3.do";		
}
function plusStr(){
	location.href = "/TaskTop_final/updatestr.do"
}
function shutdown(){
	if(confirm("컴퓨터를 종료하시겠습니까?")==true){
		alert("컴퓨터를 종료합니다. \n 오늘도 고생하셨습니다.")
	location.href ="/TaskTop_final/TTshutdown.do";
	}
}	
...
function openWin(){  
	...
	function checkexist(){
		...
		console.log(fname);		
		location.href = "/TaskTop_final/findexist.do?fname="+fname;
